    ...
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <!-- Profile dropdown -->
          <el-dropdown class="relative ml-3 flex items-center">
            <button
              ...
              <?php else : ?>
                <a href="/register" class="text-gray-300 px-3">Register</a>
                <a href="/login" class="text-gray-300 px-3">Login</a>
              <?php endif; ?>
            ...
            <?php if ($_SESSION['user'] ?? false) : ?>
              <div class="ml-2">
                <form action="/session" method="POST">
                  ...
                  <button type="submit" class="text-gray-300 px-3">Logout</span>
                </form>
              </div>
            <?php endif; ?>
          </el-dropdown>
